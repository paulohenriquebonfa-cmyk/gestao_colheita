...
import type { AreaVariedadeTalhao, AuditLog, BaseEntity, Carga, EstoqueArmazem, FeedbackItem, MovimentoEstoque, PendingOp, PilotParticipant, Talhao, VendaGrao } from './types'
